...
export const fetchHadithsByCollection = async (collection: string, limit = 20) => {
  try {
    ...
    const response = await fetch(`https://hadithapi.com/api/hadiths/?apiKey=$2y$10$XaiRFhIUSXWTeWqYL9XZucornX3e5QkctRFrrUF7ifXFShQLdbE2&collection=${collection}&limit=${limit}`);
...
const generateFallbackHadiths = () => {
  return [
    ...
    },
    {
      id: '3',
      title: 'ملك الموت',
      text: 'عن أبي هريرة رضي الله عنه قال: قال رسول الله صلى الله عليه وسلم: "كان ملك الموت يأتي الناس عياناً، فأتى موسى عليه السلام فلطمه ففقأ عينه، فرجع إلى ربه فقال: أرسلتني إلى عبد لا يريد الموت، فرد الله إليه عينه، وقال: ارجع إلى عبدي فقل له يضع يده على متن ثور، فله بكل شعرة وارت يده سنة، قال: أي رب ثم ماذا؟ قال: ثم الموت. قال: فالآن"',
      chapter: 'الأنبياء',
      number: 339,
    ...
    },
    {
      id: '5',
      title: 'خمس من الفطرة',
      text: 'عن أبي هريرة رضي الله عنه قال: قال رسول الله صلى الله عليه وسلم: "خمس من الفطرة: الختان، والاستحداد، وتقليم الأظافر، ونتف الإبط، وحلق العانة"',
      chapter: 'الطهارة',
      number: 53,
